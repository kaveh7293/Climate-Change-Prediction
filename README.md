...
<p> As such, I used a time-series model accounting for CO2 emission as an exogenious variable to predict the temprature increase. In the following, I provide a summary of what I will do for my investigations:
